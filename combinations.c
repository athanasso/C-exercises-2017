...
{
    int N;
    printf("Πόσους αριθμούς θέλετε να χρησιμοποιήσετε;\n");
    printf("Επιλογη : ");
    scanf("%d",&N);
    while(N<7||N>49)
    {
        printf("Δώσε σωστό αριθμό για το πλήθος.\nΠρέπει να ειναι μεταξύ του 7 και του 49.\n");
        scanf("%d",&N);
    }
    return N;
}
...
int *readx1x2()
{
	...
	printf("Δώσε τα όρια για το πλήθος άρτιων.\n");
	printf("Δώσε ελάχιστο πλήθος άρτιων.\n");
	scanf("%d",&x1);
	while(x1<0||x1>6)
	{
	...
	printf("Δώσε μέγιστο πλήθος άρτιων.\n");
	scanf("%d",&x2);
...
int *ready1y2()
{
	...
	printf("Δώσε τα όρια αθροίσματος των αριθμών.\n");
	printf("Δώσε το ελάχιστο άθροισμα των αριθμών.\n");
	scanf("%d",&y1);
	while(y1<21||y1>279)
	{
	...
	printf("Δώσε μέγιστο άθροισμα των αριθμών.\n");
	scanf("%d",&y2);
